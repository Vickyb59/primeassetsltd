                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              <div class="card">
                                <div class="card-body"> 
                                    <form class="form-horizontal auth-form" method="post" action="deposits-payment-option">
                                        ...
                                        <div class="form-group mb-2">                                 
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" name="deposit_amount" class="form-control" placeholder="Enter Deposit Amount" aria-label="Amount (to the nearest dollar)" />
