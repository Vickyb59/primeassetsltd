<?php
    ...
    $new_investment_planQuery = $conn->query("SELECT * FROM investment".$id." LEFT JOIN investment_plans ON investment_plans.id=investment".$id.".invest_plan_id order by 1 desc");
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                          ...
                                          <tr class="" data-id="16">
                                            ...
                                            <td class="flex">
                                                <a style="color: #fff;" href="#" class="item-title text-color badge badge-<?php if($investment_plan->status=='in progress'){echo 'info';}elseif($investment_plan->status=='cancelled'){echo 'danger';}elseif($investment_plan->status=='completed'){echo 'success';} ?>"><?= $investment_plan->status; ?></a>
                                            </td>
                                          </tr>
