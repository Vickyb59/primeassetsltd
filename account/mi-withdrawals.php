<?php
    ...
    $sql0 = "SELECT * FROM passbook".$id." WHERE debit <> 0";
                    ...
                    <div class="page-hero page-container" id="page-hero">
                        <div class="padding d-flex">
                            <div class="page-title">
                                <h2 class="text-md text-highlight">All Your Withdrawals in One Place</h2>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="p-3-4">
                                                    ...
                                                    <?php
                                                        ...
                                                        <?php
                                                            ...
                                                            <p id="none"> You have made no withdrawal </p>
                                                        <?php }
                                                        $conne->close(); ?>
                                                </div>
                                            </div>
