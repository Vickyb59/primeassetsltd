    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="hp_withdrawals_delete.php">
                <input type="hidden" class="wid" name="id">
                <div class="text-center">
                    <p>DELETE Latest withdrawal Info</p>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>Edit Latest withdrawal Info</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="hp_withdrawals_edit.php">
                <input type="hidden" class="wid" name="id">
